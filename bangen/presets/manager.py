...
BUILTIN_PRESETS: dict[str, Preset] = {
    ...
    "cyberpunk": Preset(
        ...
        effects=["glitch", "chromatic_aberration", "pulse"],
        effect_config={
            "glitch": {"intensity": 0.08},
            "chromatic_aberration": {"amplitude": 1.0},
            "pulse": {"speed": 1.0, "min_brightness": 0.55},
        },
    ),
    "matrix": Preset(
        name="matrix",
        ...
        effects=["matrix_rain", "typewriter"],
        effect_config={
            "matrix_rain": {"speed": 1.1, "amplitude": 1.3},
            "typewriter": {"chars_per_second": 80.0, "speed": 1.0},
        },
    ),
    "retro": Preset(
        name="retro",
        ...
        effects=["scanline", "flicker"],
        effect_config={
            "scanline": {"speed": 0.6},
            "flicker": {"speed": 0.9, "amplitude": 0.7},
        },
    ),
    "ocean": Preset(
        name="ocean",
        ...
        gradient_direction="vertical",
        effects=["wave", "gradient_shift"],
        effect_config={
            "wave": {"speed": 1.0, "amplitude": 1.5, "frequency": 0.8},
            "gradient_shift": {"speed": 0.7},
        },
    ),
    "vaporwave": Preset(
        name="vaporwave",
        ...
        effects=["scroll", "rainbow_cycle", "pulse"],
        effect_config={
            "scroll": {"speed": 0.8},
            "pulse": {"speed": 0.7, "min_brightness": 0.4},
            "rainbow_cycle": {"speed": 0.6},
        },
    ),
    "electric": Preset(
        name="electric",
        ...
        effects=["electric", "glow"],
        effect_config={
            "electric": {"speed": 2.8, "amplitude": 1.3},
            "glow": {},
        },
    ),
    "fire": Preset(
        ...
        effects=["fire", "melt"],
        effect_config={
            "fire": {"speed": 1.6, "amplitude": 1.2, "frequency": 1.4},
            "melt": {"speed": 1.0, "amplitude": 1.0, "frequency": 1.1},
        },
    ),
    "neon_sign": Preset(
        name="neon_sign",
        font="ansi_shadow",
        gradient="#ff4fd8:#8affff",
        effects=["neon_sign"],
        effect_config={"neon_sign": {"speed": 1.0, "amplitude": 1.0}},
    ),
    "vhs": Preset(
        name="vhs",
        font="standard",
        gradient="#ff77cc:#66ccff",
        effects=["vhs_glitch", "scanline"],
        effect_config={
            "vhs_glitch": {"speed": 1.4, "amplitude": 1.2},
            "scanline": {"speed": 0.8},
        },
    ),
}
